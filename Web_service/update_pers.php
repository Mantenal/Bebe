...
$json=array();
	...
	if(isset($_GET["id"])&& isset($_GET["ritmo_c_max"]) && isset($_GET["notificacion_s"]) && isset($_GET["notificacion_r"]) ){
        $id=$_GET['id'];
        $rit_max=$_GET['ritmo_c_max'];
        $not_s=$_GET['notificacion_s'];
        $not_r=$_GET['notificacion_r'];
	
		
		$conexion=mysqli_connect($hostname_localhost,$username_localhost,$password_localhost,$database_localhost);
		
    $insert="UPDATE personalizacion SET ritmo_c_max='{$rit_max}',notificacion_s='{$not_s}',notificacion_r='{$not_r}' WHERE id='{$id}'";
