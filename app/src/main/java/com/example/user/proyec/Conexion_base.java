...
public class Conexion_base extends SQLiteOpenHelper{
    ...
    final String CREAR_TABLA_INFO="CREATE TABLE info(id INT, años INT,alarmas INT,tempe float,ppm_mx int,perso int,tempe2 float,ppm_mx2 int)";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("INSERT INTO info(id,años,alarmas,tempe,ppm_mx,perso,tempe2,ppm_mx2)values(0,0,0,0,0,0,0,0)");
